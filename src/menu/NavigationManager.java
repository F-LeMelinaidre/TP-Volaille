...
public class NavigationManager
{
    ...
    /*private static MenuHandler currentHandler;

    public static MenuHandler getCurrentHandler() {
        return currentHandler;

    }
    public static void mainMenu(MenuRenderer menu) {
        App.getInstance().setCurrentHandler(new MainMenuHandler());
    }*/
    public static void menuVolailleGroup() {
